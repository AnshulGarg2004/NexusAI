...
const Loading = () => {
    ...
    const Thinking_Labels = ['Thinking...', 'Analysing...', 'Reasoning...', 'Generating...'];
      ...
      <div className='  relative w-9 h-9 flex items-center justify-center shrink-0'>
        {
            [0, 0.45, 0.9].map((delay, i) => (
                ...
                initial={{scale : 0.33, opacity : 0.55}}
        ...
        <motion.span className=' w-2.5 h-2.5 rounded-full bg-linear-to-br from-cyan-300 to-violet-400'
